        ...
        @method('PUT')
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Email:</strong>
                    <input type="email" name="email"  id="email" class="form-control" value="{{ $company->email }}" placeholder="Company Name Email">
		        </div>
		    </div> 
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Logo:</strong>
                    <input accept="image/*" type="file" placeholder="Enter company logo" id="image" class="form-control" name="image" value="{{ $company->image }}">
		        </div>
		    </div> 
